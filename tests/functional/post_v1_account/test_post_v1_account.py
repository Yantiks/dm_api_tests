...
@pytest.mark.parametrize(
    ...
    [
        # 1. Короткий пароль
        ("validlogin12", "user12@example.com", "123", 400, "Validation failed"),

        # 2. Невалидный email
        ("validlogin13", "invalidemail.com", "validPass123", 400, "Validation failed"),

        # 3. Невалидный логин
        ("a", "user13@example.com", "validPass123", 400, "Validation failed"),
    ]
)
