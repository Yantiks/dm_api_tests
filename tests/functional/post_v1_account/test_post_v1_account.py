...
@pytest.mark.parametrize(
    ...
    [
        # 1. Короткий пароль
        ("validlogin5", "user5@example.com", "123", 400, "Validation failed"),

        # 2. Невалидный email
        ("validlogin6", "invalidemail.com", "validPass123", 400, "Validation failed"),

        # 3. Невалидный логин
        ("a", "user6@example.com", "validPass123", 400, "Validation failed"),
    ]
)
